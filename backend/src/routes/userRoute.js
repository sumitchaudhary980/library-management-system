...
router.post("/fines/:id/pay", requireReader, userController.payFine);
router.get("/fines/esewa/success", userController.esewaSuccess);
router.get("/fines/esewa/failure", userController.esewaFailure);
//PROFILE ROUTE
